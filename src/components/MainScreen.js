...
import {View, TouchableOpacity, Pressable, StyleSheet,Button, Text} from 'react-native';
...
class MainScreen extends React.Component{
    ...
    render(){
        Tts.speak('유희얼입니다.왼쪽으로 스와이프하면 유통기한, 오른쪽으로 스와이프하면 바코드를 알 수 있습니다.');
        const {pausePreview} = this.state;
        return(
            <SwipeableViews style={styles.mainMenu} index={1} onChangeIndex={this.speak}>
